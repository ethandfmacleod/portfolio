    ...
    return (
        <>
            ...
            <div className="border-4 block md:hidden text-center p-4 rounded-md">
                Online PDF viewing cannot be done on mobile, visit the{' '}
                <a
                    href="https://github.com/ethandfmacleod/Honours"
            ...
            <div className="hidden md:flex flex-col gap-8 md:flex-row md:gap-12">
                ...
                <div className="flex flex-col gap-4">
                    <div className="font-semibold text-xl text-center">
                        Pinch Analysis as a Modular Tool for the Analysis and
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 justify-end">
                        <DownloadFileButton
                            text="Dissertation"
                            href="/zips/Dissertation.zip"
                            file="Dissertation.zip"
                        />
                        <DownloadFileButton
                            text="Literature Review"
                            href="/zips/LiteratureReview.zip"
                            file="LiteratureReview.zip"
                        />
                    </div>
                </div>
            </div>
